...
namespace Ironcow
{
    public static class ExtensionMethods
    {
        ...
        public static Vector3 GetDirectionNormal(this Rigidbody rb)
        {
            ...
            {
                return rb.angularVelocity.normalized;
            }
            else if (rb.GetAccumulatedForce() != Vector3.zero)
            {
                return rb.GetAccumulatedForce().normalized;
            }
            return Vector3.zero;
        }
