...
namespace Ironcow.Convenience
{
    public class SceneSelect : EditorWindow
    {
        ...
        static string ScenePath { get => Application.dataPath + EditorDataSetting.ScenePath.Replace("Assets", "") + "/"; }
        static string EditorScenePath { get => Application.dataPath + EditorDataSetting.EditorScenePath.Replace("Assets", "") + "/"; }
        static string DontDestroyScenePath { get => Application.dataPath + EditorDataSetting.DontDestroyScenePath.Replace("Assets", ""); }
        static string IntroScenePath { get => Application.dataPath + EditorDataSetting.IntroScenePath.Replace("Assets", ""); }
